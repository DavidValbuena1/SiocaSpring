...
public class VentaController {
    ...
    public ResponseEntity<Resource> descargar(@RequestParam Map<String, Object> params)
            throws IOException, JRException {
        Reportes dto = service.obtenerReporte(params);
    ...
    @GetMapping(path = { "/ventasPorMes" })
    public ResponseEntity<Resource> ventasPorMes(@RequestParam Map<String, Object> params) throws IOException, JRException {
        Reportes dto = service.ventasPorMes(params);
